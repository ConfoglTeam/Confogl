...
new bool:confogl_available = false;
...
#define IsConfoglAvailable() (confogl_available)
...
public APLRes:AskPluginLoad2(Handle:myself, bool:late, String:error[], err_max)
{
	...
	CreateNative("ScoreMod_GetCurrentHealthBonus", _native_GetCurrentHB);
...
{
	return confogl_available ? LGO_GetMapValueInt("max_distance", -1) : -1;
}
...
public _native_GetCurrentHB(Handle:plugin, numParams)
{
