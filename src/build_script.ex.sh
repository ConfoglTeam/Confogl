...
# l4d2util: https://github.com/ConfoglTeam/l4d2util
L4D2UTIL="l4d2util"
...
make SOURCEMOD=$SOURCEMOD CRXGIT=$CRXGIT CRXSTUFF=$CRXSTUFF PSIMSTUFF=$PSIMSTUFF LGOFNOC=$LGOFNOC DONSTUFF=$DONSTUFF VINTIK=$VINTIK L4D2UTIL=$L4D2UTIL L4D2DIRECT=$L4D2DIRECT
